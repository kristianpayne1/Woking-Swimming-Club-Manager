...
public class Application
{
    ...
    private static void start() 
    {
        try
        {         
            database = new DatabaseConnection("WSCDB.db");        // Initiate the database connection.

            /* Load the first fxml file that will create our first JavaFX scene. */
            FXMLLoader loader = new FXMLLoader(Application.class.getResource("LoginGUI.fxml"));

            /* Each scene requires a Window, called a stage. The following creates and displays the stage. */
            Stage stage = new Stage();
            stage.setTitle("Woking Swimming Club Manager");
